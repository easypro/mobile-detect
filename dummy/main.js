...
if (md.mobile()) {
    if (md.phone()) {
        window.location="https://easypro.github.io/mobile-detect/phone.html";
    } else if (md.tablet()) {
        window.location="https://easypro.github.io/mobile-detect/tablet.html";
    }
} else {
    window.location="https://easypro.github.io/mobile-detect/desktop.html";
}